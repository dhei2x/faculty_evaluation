...
if ($search !== '') {
  $query .= " WHERE faculty_id LIKE ? OR last_name LIKE ? OR first_name LIKE ? OR department LIKE ?";
  ...
  <div class="flex-1 flex justify-center items-start">
    <div class="content-wrapper">
      <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Manage Faculties</h1>
        ...
        <table class="min-w-full table-auto border border-gray-200">
          ...
          <tbody>
                ...
                <td class="border px-4 py-2">
                  <div class="relative dropdown inline-block text-left">
                    ...
                    <div id="menu<?= $i ?>" 
                      ...
                      <a href="edit_faculty.php?id=<?= urlencode($faculty['faculty_id']) ?>" 
                         class="block px-4 py-2 text-sm text-blue-600 hover:bg-gray-100">Edit</a>
                      <a href="delete_faculty.php?id=<?= urlencode($faculty['faculty_id']) ?>" 
            ...
            <?php if (empty($faculties)): ?>
              <tr>
                <td colspan="5" class="text-center py-6 text-gray-500">No faculty members found.</td>
              </tr>
            <?php endif; ?>
          </tbody>
        </table>
